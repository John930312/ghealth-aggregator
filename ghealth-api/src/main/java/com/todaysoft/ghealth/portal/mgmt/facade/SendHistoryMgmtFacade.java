...
import com.todaysoft.ghealth.service.wrapper.SendHistoryWrapper;

@Component
public class SendHistoryMgmtFacade
{
    @Autowired
    private SendHistoryWrapper wrapper;
    
    @Autowired
    private ISendHistoryService service;
    
    @Autowired
    private ISendOrderDetailService sendOrderDetailService;
    ...
    {
        List<com.todaysoft.ghealth.mybatis.model.SignInHistory> signInHistories = sendOrderDetailService.getSearch(request.getId());
