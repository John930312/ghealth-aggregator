...
{
  var HOSTED_VIEWER_ORIGINS = ['null', 'http://gtreport.hsgene.cn', 'https://gtreportssl.hsgene.com'];
...
function webViewerInitialized() {
  ...
  var file = '';
  if('file' in params){
      if(params.file.indexOf('http://')!=-1||params.file.indexOf('https://')!=-1){
          file = params.file;
      } else {
          file = params.file;
      }
...
function getViewerConfiguration() {
  return {
    ...
    debuggerScriptPath: './debugger.js',
      defaultFileDomain: 'http://gtreport.hsgene.cn/',
